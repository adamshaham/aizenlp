...
const DesktopNewsletter = ({ className = "" }) => {
  return (
    <div
      className={`self-stretch overflow-hidden flex flex-col items-start justify-start pt-[9.8px] px-[9px] pb-[9.6px] text-left text-3xl text-[#fff] font-button1 ${className}`}
    >
      <H />
      <TextParagraphe />
      <MailingInput1 />
