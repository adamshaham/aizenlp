...
const BasicPlan = ({ className = "", basicPlan, propMinWidth }) => {
  ...
  return (
    <div
      className={`self-stretch rounded-t-[15.56px] rounded-b-none bg-accent-1 overflow-hidden flex flex-row items-center justify-center py-[31.1px] px-[29px] gap-[31.1px] text-left text-xl-4 text-[#fff] font-montserrat mq450:flex-wrap gap-4 ${className}`}
    >
      <div
