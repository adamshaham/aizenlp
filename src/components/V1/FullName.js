  ...
  return (
    ...
    >
      ...
      <div className="self-stretch rounded-[38.89px] border-[#fff] border-[1px] border-solid box-border overflow-hidden flex flex-row items-center justify-start py-3.5 pl-[15px] pr-3.5 max-w-full">
        <input
          className="w-full [border:none] [outline:none] font-medium font-plus-jakarta-sans text-[15.6px] bg-[transparent] h-6 flex-1 relative leading-[23.33px] text-[#fff] text-left inline-block min-w-[250px] max-w-full p-0"
