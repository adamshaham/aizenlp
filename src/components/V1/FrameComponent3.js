...
const FrameComponent3 = ({ className = "" }) => {
  ...
  const contentData = {
    ...
    questions: [
      ...
      },
      {
        ...
        answer:
          "Yes, we offer a variety of sustainable and eco-friendly landscaping options to help you create a beautiful and environmentally friendly outdoor space.",
      },
      {
        question:
          "How do I request a consultation or estimate for my landscaping project?",
        answer:
          "You can request a consultation or estimate by contacting us through our website or giving us a call. We will be happy to discuss your project and provide a detailed estimate.",
      },
      {
        question: "What factors influence the cost of a landscaping project?",
        answer:
          "Several factors influence the cost of a landscaping project, including the size and scope of the project, the materials used, and the complexity of the design. We provide detailed estimates to help you understand the costs involved.",
      },
      {
        question:
          "How often should I schedule landscape maintenance services?",
        answer:
          "The frequency of landscape maintenance services depends on your specific needs and preferences. We offer customized maintenance plans to ensure your outdoor space remains beautiful and well-maintained throughout the year.",
      },
    ],
  };
  ...
  return (
    <section
      className={`self-stretch flex flex-row items-start justify-center pt-0 px-5 pb-[82.4px] box-border max-w-full text-center text-[65px] text-[#232a42] font-montserrat lg:pb-[54px] lg:box-border mq750:pb-[35px] mq750:box-border ${className}`}
    >
      <div className="w-[1440.4px] flex flex-col items-start justify-start gap-[77.5px] max-w-full gap-[19px] gap-[39px]">
        ...
        <div className="self-stretch flex flex-col items-center justify-center gap-[38.8px] max-w-full text-left text-[27.2px] text-[#fff]">
