    ...
    >
      <div className="w-[1440px] flex flex-row items-start justify-center py-0 px-0 box-border gap-[93.3px] max-w-full mq1050:flex-wrap gap-[23px] gap-[47px]">
        ...
        <div className="flex-1 flex flex-col items-start justify-start pt-0 px-0 pb-[0.1px] box-border gap-[38.9px] min-w-[385px] max-w-full mq450:min-w-full gap-[19px]">
          ...
          <div className="self-stretch flex flex-col items-start justify-start py-0 pl-0 pr-[23px] box-border gap-[38.9px] max-w-full text-8xl-2 gap-[19px]">
            <div className="self-stretch flex flex-row items-center justify-start gap-[23.3px] max-w-full shrink-0 mq750:flex-wrap">
              <img
                ...
                src="/icon-21.svg"
              />
              <div className="flex-1 relative leading-[32px] font-semibold inline-block min-w-[102px] max-w-full mq450:text-3xl mq450:leading-[25px]">
                Expertise
              </div>
            </div>
            <div className="self-stretch flex flex-row items-center justify-start gap-[23.3px] max-w-full shrink-0 mq750:flex-wrap">
              <img
                ...
                src="/icon-21.svg"
              />
              <div className="flex-1 relative leading-[32px] font-semibold inline-block min-w-[119px] max-w-full mq450:text-3xl mq450:leading-[25px]">
                Timeliness
              </div>
            </div>
            <div className="self-stretch flex flex-row items-center justify-start gap-[23.3px] max-w-full shrink-0 mq750:flex-wrap">
              <img
                ...
                src="/icon-21.svg"
              />
              <div className="flex-1 relative leading-[32px] font-semibold inline-block min-w-[160px] max-w-full mq450:text-3xl mq450:leading-[25px]">
                Customization
              </div>
            </div>
            <div className="self-stretch flex flex-row items-center justify-start gap-[23.3px] max-w-full shrink-0 mq750:flex-wrap">
              <img
                ...
                src="/icon-21.svg"
              />
              <div className="flex-1 relative leading-[32px] font-semibold inline-block min-w-[244px] max-w-full mq450:text-3xl mq450:leading-[25px]">
                Quality Workmanship
              </div>
            </div>
          </div>
