...
const Expertise = ({ className = "" }) => {
  ...
  return (
    <section
      className={`self-stretch flex flex-row items-start justify-center pt-0 px-5 pb-[81.6px] box-border max-w-full text-left text-[65px] text-[#232a42] font-montserrat mq1050:pb-[53px] mq1050:box-border mq750:pb-[34px] mq750:box-border ${className}`}
    >
      <div className="w-[1440px] flex flex-col items-start justify-start gap-[77.4px] max-w-full gap-[19px] gap-[39px]">
        ...
        <div className="self-stretch flex flex-row items-start justify-start gap-[93.3px] max-w-full text-[27.2px] mq1050:flex-wrap gap-[23px] gap-[47px]">
