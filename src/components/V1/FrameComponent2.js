...
const FrameComponent2 = ({ className = "" }) => {
  return (
    <section
      className={`w-[1440.9px] flex flex-row items-center justify-center pt-0 px-5 pb-[81.2px] box-border max-w-full text-center text-46xl-1 text-[#232a42] font-montserrat mq1050:pb-[53px] mq1050:box-border mq450:pb-[34px] mq450:box-border ${className}`}
    >
