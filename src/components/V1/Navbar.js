...
const Navbar = ({ className = "" }) => {
  return (
    <header
      className={`self-stretch border-[#fff] border-b-[1px] border-solid box-border flex flex-row items-center justify-between pt-[23.3px] px-[95px] pb-[22px] top-[0] z-[99] sticky gap-5 text-left text-17xl-9 text-[#fff] font-montserrat mq1050:pl-[47px] mq1050:pr-[47px] mq1050:box-border mq750:pl-[23px] mq750:pr-[23px] mq750:box-border ${className}`}
    >
      <a className="[text-decoration:none] relative leading-[47px] font-semibold text-[inherit] whitespace-nowrap">
        {contentdata.brandName}
      </a>
      <div className="w-[540.9px] flex flex-row items-center justify-between max-w-full text-base-6 mq1050:hidden">
