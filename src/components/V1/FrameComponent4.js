...
const FrameComponent4 = ({ className = "" }) => {
  return (
    <section
      className={`self-stretch flex flex-row items-start justify-center pt-0 px-5 pb-[79px] box-border max-w-full text-center text-46xl-1 text-[#232a42] font-montserrat mq1050:pb-[51px] mq1050:box-border mq750:pb-[33px] mq750:box-border ${className}`}
    >
      <div className="w-[1209.4px] flex flex-col items-start justify-start gap-[77.5px] max-w-full shrink-0 gap-[19px] gap-[39px]">
        ...
        <div className="self-stretch flex flex-row flex-wrap items-start justify-center gap-[38.9px] max-w-full text-left text-base-6 text-[#2da884] gap-[19px]">
