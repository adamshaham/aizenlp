...
const SecondHeadline = ({ className = "" }) => {
  return (
    <div
      className={`w-[596.7px] overflow-hidden flex flex-row items-center justify-start py-0 px-2 box-border max-w-[125%] shrink-0 text-left text-33xl text-[#fff] font-body-base-regular ${className}`}
    >
