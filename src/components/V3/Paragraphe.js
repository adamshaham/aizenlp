...
const Paragraphe = ({
  ...
  return (
    <div
      className={`overflow-hidden flex flex-row items-center justify-start pt-[8.8px] px-2 pb-[8.9px] text-center text-base text-second-text font-body-base-regular ${className}`}
