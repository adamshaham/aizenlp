...
const Headline = ({ className = "" }) => {
  return (
    <div
      className={`self-stretch overflow-hidden flex flex-row items-start justify-start pt-[8.8px] px-2 pb-[8.9px] box-border shrink-0 max-w-full text-center text-61xl text-neutral-n0 font-body-base-regular ${className}`}
    >
