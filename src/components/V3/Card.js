...
const Card = ({
  ...
  return (
    <div
      className={`self-stretch rounded-[8.87px] bg-[#181818] border-[#dedede] border-[0.9px] border-solid flex flex-col items-start justify-start py-[34px] pl-[35px] pr-[25px] gap-[26.6px] text-left text-[16px] text-[#fff] font-body-base-regular ${className}`}
    >
      <div
