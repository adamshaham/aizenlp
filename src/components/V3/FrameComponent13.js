  ...
  return (
    ...
    >
      <div className="flex-1 bg-[#181818] overflow-hidden flex flex-col items-center justify-start py-[70.9px] px-5 box-border max-w-full mq725:pt-[46px] mq725:pb-[46px] mq725:box-border">
        <div className="w-[1080.8px] shadow-[0px_3.5px_27.49px_rgba(0,_0,_0,_0.15)] rounded-[29.26px] bg-[#343434] overflow-hidden flex flex-row items-center justify-start py-[2.7px] px-0 box-border gap-[76.3px] max-w-full shrink-0 gap-[38px] gap-[19px] mq1000:flex-wrap">
