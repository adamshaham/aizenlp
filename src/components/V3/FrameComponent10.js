...
const FrameComponent10 = ({ className = "" }) => {
  return (
    <section
      className={`self-stretch flex flex-row items-start justify-start pt-0 px-0 pb-[13.2px] box-border text-left text-[52px] text-[#fff] font-body-base-regular ${className}`}
    >
