...
const FrameComponent16 = ({ className = "" }) => {
  return (
    <section
      className={`self-stretch flex flex-row items-start justify-center pt-0 px-5 pb-[98.8px] box-border max-w-full shrink-0 text-center text-[38px] text-[#060e1a] font-body-base-regular mq800:pb-16 mq800:box-border ${className}`}
    >
      <div className="w-[997.5px] flex flex-col items-end justify-start gap-[53.2px] max-w-full gap-[27px]">
        <div className="self-stretch flex flex-row items-start justify-center py-0 pl-[21px] pr-5 box-border max-w-full">
          <div className="w-[586.3px] flex flex-col items-end justify-start gap-[25.2px] max-w-full">
            ...
            <div className="self-stretch relative text-[16px] leading-[160%] text-[#051114b3]">
        ...
        <div className="self-stretch flex flex-col items-start justify-start gap-[43.8px] text-left text-[10px] text-[#051114] gap-[22px]">
