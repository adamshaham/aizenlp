...
const FrameComponent17 = ({ className = "" }) => {
  return (
    <section
      className={`self-stretch flex flex-row items-start justify-center pt-0 px-5 pb-[107.5px] box-border max-w-full shrink-0 text-center text-[38px] text-[#051114] font-body-base-regular mq450:pb-[45px] mq450:box-border mq800:pb-[70px] mq800:box-border ${className}`}
    >
      <div className="w-[997.4px] flex flex-col items-start justify-start gap-[52.5px] max-w-full gap-[26px]">
        <div className="self-stretch flex flex-row items-start justify-center py-0 pl-5 pr-[22px]">
          <div className="w-[405px] relative leading-[130%] font-semibold inline-block mq450:text-[23px] mq450:leading-[30px] mq800:text-[31px] mq800:leading-[40px]">
            Lastest insights news
          </div>
        </div>
        <div className="self-stretch flex flex-row flex-wrap items-start justify-center gap-[26.2px] max-w-full text-left text-[12px] text-[#051114b3]">
          <NewsCard
