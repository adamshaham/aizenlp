...
const Features = ({ className = "" }) => {
  return (
    <section
      className={`self-stretch flex flex-row items-end justify-start pt-0 pb-[107.5px] pl-[798px] pr-[157px] box-border gap-[116.4px] max-w-full shrink-0 text-left text-[38px] text-[#051114] font-body-base-regular gap-[29px] mq450:pl-5 mq450:box-border gap-[58px] mq800:pl-[199px] mq800:pr-[39px] mq800:pb-[70px] mq800:box-border mq1350:flex-wrap mq1350:pl-[399px] mq1350:pr-[78px] mq1350:box-border ${className}`}
    >
      ...
      <div className="flex flex-col items-start justify-end pt-0 px-0 pb-[28.3px] box-border min-w-[444.5px] max-w-full mq450:min-w-full mq800:min-w-full mq1125:min-w-full mq1350:flex-1 mq1350:min-w-full">
        <div className="flex flex-col items-start justify-start gap-[43.7px] shrink-0 max-w-full gap-[22px]">
          <div className="relative leading-[130%] font-semibold mq450:text-[23px] mq450:leading-[30px] mq800:text-[31px] mq800:leading-[40px]">
            <p className="m-0"></p>
            <p className="m-0"></p>
          </div>
          <div className="flex flex-row items-start justify-start gap-[21.9px] max-w-full text-[22px]">
            ...
            <div className="flex flex-col items-start justify-start gap-[24.8px] max-w-[calc(100%_-_43px)]">
              {contentData.features.map((feature, index) => (
                ...
                >
                  <div className="relative leading-[33px] font-medium mq450:text-[11.6px] mq450:leading-[26px]"></div>
                  <div className="relative text-[12px] leading-[160%] text-[#051114b3]">
                    <p className="m-0"></p>
                    <p className="m-0"></p>
                  </div>
                </div>
