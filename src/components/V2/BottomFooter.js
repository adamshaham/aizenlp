...
const BottomFooter = ({ className = "" }) => {
  return (
    <div
      className={`w-[259.3px] flex flex-col items-start justify-start py-0 pl-0 pr-[7px] box-border gap-[27.4px] text-left text-[26px] text-[#4452fe]1 font-body-base-regular ${className}`}
    >
      <div className="flex flex-row items-start justify-start">
        ...
        <div className="flex flex-col items-start justify-start pt-[2.6px] px-0 pb-0 ml-[-1.6px]">
          <i className="relative tracking-[0.01em] leading-[150%] inline-block font-bold min-w-[95px] z-[1] mq450:text-[21px] mq450:leading-[32px]">
            Codext
          </i>
        </div>
      </div>
      <div className="h-[66px] relative text-[14px] leading-[160%] text-[#ffffffb3] inline-block z-[1]">
