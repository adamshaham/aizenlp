  ...
  return (
    ...
    >
      <div className="flex-1 flex flex-col items-start justify-start pt-[35px] pb-[159.9px] pl-[201px] pr-[72px] box-border relative gap-[68.6px] max-w-full shrink-0 gap-[17px] mq450:pl-5 mq450:pt-5 mq450:pb-[68px] mq450:box-border gap-[34px] mq800:pt-[23px] mq800:pb-[104px] mq800:pl-[100px] mq800:pr-9 mq800:box-border">
        <header className="w-[998px] flex flex-row items-end justify-between gap-5 max-w-full text-left text-7xl-3 text-primary1 font-body-base-regular">
          ...
          <div className="w-[627px] flex flex-row items-end justify-start gap-[51.8px] max-w-full text-base-8 text-first-text gap-[26px]">
          ...
          <div className="w-[435.8px] flex flex-col items-start justify-start pt-0 px-0 pb-[55px] box-border min-w-[435.8px] min-h-[432px] max-w-full mq450:pb-9 mq450:box-border mq800:min-w-full mq1350:flex-1">
            <div className="self-stretch flex flex-col items-start justify-start gap-[31.8px] max-w-full gap-4">
              ...
              <button className="cursor-pointer [border:none] pt-[13.1px] px-[25px] pb-[13.2px] bg-[#fff] rounded-[4.38px] flex flex-row items-start justify-start whitespace-nowrap z-[1] hover:bg-gainsboro-200">
                <div className="relative text-mid-5 leading-[160%] font-medium font-body-base-regular text-first-text text-left">
                  Try A Live Demo
                </div>
              </button>
            </div>
