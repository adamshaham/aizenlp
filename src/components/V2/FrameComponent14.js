...
const contentData = {
  ...
  description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. A nulla nulla etiam turpis quam diam et. Arcu nisi, sed aenean sit nisl.",
...
const FrameComponent14 = ({ className = "" }) => {
  return (
    <section
      className={`self-stretch flex flex-row items-start justify-start pt-0 px-0 pb-[108.1px] box-border max-w-full shrink-0 text-left text-35xl-3 text-[#fff] font-body-base-regular mq450:pb-[45px] mq450:box-border mq1125:pb-[70px] mq1125:box-border ${className}`}
    >
      <div className="flex-1 flex flex-col items-start justify-start pt-[35px] pb-[159.9px] pl-[201px] pr-[72px] box-border relative gap-[68.6px] max-w-full shrink-0 gap-[17px] mq450:pl-5 mq450:pt-5 mq450:pb-[68px] mq450:box-border gap-[34px] mq800:pt-[23px] mq800:pb-[104px] mq800:pl-[100px] mq800:pr-9 mq800:box-border">
        <header className="w-[1440px] flex flex-row items-end justify-between gap-5 max-w-full text-left text-7xl-3 text-[#4452fe]1 font-body-base-regular">
          <div className="flex flex-col items-start justify-end pt-0 px-0 pb-[3.3px]">
            <div className="flex flex-row items-start justify-start">
              ...
              <div className="flex flex-col items-start justify-start pt-[2.6px] px-0 pb-0 ml-[-1.6px]">
                <i className="relative tracking-[0.01em] leading-[150%] inline-block font-bold min-w-[95px] whitespace-nowrap z-[1]">
                  
                </i>
              </div>
            </div>
          </div>
          <div className="w-[627px] flex flex-row items-end justify-start gap-[51.8px] max-w-full text-base-8 text-[#000] gap-[26px]">
                ...
                <nav className="m-0 self-stretch flex flex-row items-start justify-start py-0 pl-2 pr-0 box-border max-w-full mq800:hidden">
                  <nav className="m-0 flex-1 flex flex-row items-start justify-between max-w-full gap-5 text-left text-base-8 text-[#ffffffcc] font-body-base-regular">
                    {contentData.navItems.map((item, index) => (
                      <div key={index} className="relative leading-[160%] font-medium text-[#fff] inline-block min-w-[45px] z-[1]">
            ...
            <div className="rounded-[4.38px] bg-[#fff] flex flex-row items-start justify-start pt-[13.1px] px-[26px] pb-[13.2px] whitespace-nowrap z-[1]">
              <div className="relative leading-[160%] font-medium inline-block min-w-[88px]">
