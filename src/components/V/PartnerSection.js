...
const PartnerSection = ({ className = "" }) => {
  ...
  return (
    <div
      className={`self-stretch bg-[#fff] flex flex-col items-center justify-start pt-[38.9px] px-5 pb-[58px] box-border min-h-[314px] shrink-0 max-w-full text-center text-[16px] text-[#4b5162cc] font-body-base-regular ${className}`}
    >
      <div className="w-[1440.6px] flex flex-col items-center justify-start pt-0 px-0 pb-[0.1px] box-border gap-[19.4px] max-w-[1440.56px] lg:max-w-full">
        ...
        <div className="w-full h-[172.2px] overflow-x-auto shrink-0 flex flex-row flex-wrap items-center justify-center pt-[19.5px] pb-[19.4px] pl-[53px] pr-[52px] box-border gap-x-stack-[23px] gap-y-stack-[23px] min-w-[972.22px] max-w-[1170.56px] lg:pl-[26px] lg:pr-[26px] lg:box-border lg:max-w-full gap-stack-[23px]">
