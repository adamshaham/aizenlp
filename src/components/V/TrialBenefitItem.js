  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col items-start justify-start min-w-[187px]">
        ...
        <div className="self-stretch relative leading-[23.33px] text-[#ffffffb3] [display:-webkit-inline-box] overflow-hidden text-ellipsis [-webkit-line-clamp:2] [-webkit-box-orient:vertical]">
          {benefitDescriptions}
        </div>
      </div>
    </div>
