...
const SmallEyebrowTagLabelStyle = ({
  ...
  return (
    <div
      className={`w-[81.6px] shadow-[0px_0px_0.97px_rgba(44,_58,_114,_0.05),_0px_1.9px_5.83px_rgba(44,_58,_114,_0.05),_0px_9.7px_17.5px_rgba(58,_76,_146,_0.1)] rounded-xl bg-[#fff] border-[#b6bcce] border-[1px] border-solid box-border flex flex-row items-center justify-start py-1.5 pl-[11px] pr-2.5 gap-[7.8px] text-center text-base-6 text--[#4b5162] font-body-base-regular ${className}`}
