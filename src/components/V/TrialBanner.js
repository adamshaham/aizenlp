  ...
  return (
    ...
    >
      <div className="h-[415.2px] w-[1170.6px] rounded-13xl bg-[#387ff5] overflow-hidden shrink-0 flex flex-col items-start justify-start py-inset-6xl px-[58px] box-border relative gap-[7.8px] max-w-[1170.6px] lg:max-w-full mq450:h-auto mq450:min-h-[415.2]">
        ...
        />
        <div className="w-[1053.9px] !m-[0] absolute top-[58.3px] left-[58.4px] flex flex-row flex-wrap items-start justify-start py-0 pl-0 pr-[3px] box-border gap-x-[38.9px] gap-y-[36.9px] max-w-full z-[1]">
          ...
          <div className="w-[370px] flex flex-col items-start justify-start gap-stack-xl min-w-[350px] max-w-full text-base-6 font-body-base-regular">
            <TrialBenefitItem
              iconcreditCardCursorClick="/iconcredit-card-cursor-click.svg"
              courseName="Instant Access"
              benefitDescriptions="Begin exploring Neuros's full suite of features immediately"
            />
            <TrialBenefitItem
              iconcreditCardCursorClick="/iconchart-rates-checkmark@2x.png"
            ...
            />
            <TrialBenefitItem
              iconcreditCardCursorClick="/iconworld-transaction-transfer.svg"
