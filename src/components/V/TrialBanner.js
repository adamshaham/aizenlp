...
const TrialBanner = ({ className = "" }) => {
  ...
  return (
    <div
      className={`pb-[100px] self-stretch bg-[#fff] overflow-hidden flex flex-row items-start justify-center py-[7.8px] px-5 box-border shrink-0 max-w-full z-[3] text-left text-[46.7px] text-[#fff] font-dm-sans gap-section-spacing-[11.6px] mq750:pb-[51px] mq750:box-border ${className}`}
    >
      <div className="h-[415.2px] w-[1440.6px] rounded-[32px] bg-[#387ff5] overflow-hidden shrink-0 flex flex-col items-start justify-start py-inset-6xl px-[58px] box-border relative gap-[7.8px] max-w-[1440.6px] lg:max-w-full mq450:h-auto mq450:min-h-[415.2px]">
        <img
        ...
        <div className="w-[1320.9px] !m-[0] absolute top-[58.3px] left-[58.4px] flex flex-row flex-wrap items-start justify-start py-0 pl-0 pr-[3px] box-border gap-x-[38.9px] gap-y-[36.9px] max-w-full z-[1]">
          <div className="flex-1 flex flex-col items-start justify-start gap-stack-[23px] min-w-[350px] max-w-full">
            <b className="self-stretch relative leading-[116%] mq450:text-[28px] mq450:leading-[33px] mq1050:text-[37px] mq1050:leading-[43px]">
          ...
          <div className="w-[370px] flex flex-col items-start justify-start gap-stack-[20px] min-w-[350px] max-w-full text-[15.6px] font-body-base-regular">
