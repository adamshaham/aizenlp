...
const ValueSection = ({ className = "" }) => {
  return (
    <div
      className={`self-stretch bg-[#fff] overflow-hidden flex flex-row items-start justify-center pt-[124.4px] px-5 pb-[109px] box-border shrink-0 max-w-full z-[1] text-center text-18xl-9 text-[#1c1f25] font-dm-sans lg:pt-[124.4px]  lg:box-border  mq750:pb-[46px] mq750:box-border ${className}`}
    >
