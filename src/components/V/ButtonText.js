...
const ButtonText = ({
  ...
  return (
    <button
      className={`cursor-pointer border-primary-pr300 border-[1px] border-solid py-[11.7px] px-[18px] bg-neutral-n0 self-stretch w-[124px] [backdrop-filter:blur(11.67px)] rounded-lg box-border overflow-hidden shrink-0 flex flex-row items-center justify-center ${className}`}
    ...
    >
      ...
      >
        <b
          className="self-stretch w-[71px] relative text-base-6 leading-[122%] inline-block font-dm-sans text-primary-pr600 text-left"
          style={textStyle}
        >
          {buttonText}
        </b>
