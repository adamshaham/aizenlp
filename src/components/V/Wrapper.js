...
const Wrapper = ({
  ...
  return (
    <div
      className={`flex-[0.9863] flex flex-col items-start justify-center py-0 pl-0 pr-[125px] box-border gap-stack-lg min-w-[155px] text-left text-base-6 text-neutral-n900 font-dm-sans mq450:pr-5 mq450:box-border ${className}`}
      style={wrapperStyle}
    >
