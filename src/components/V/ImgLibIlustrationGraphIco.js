...
const ImgLibIlustrationGraphIco = ({ className = "" }) => {
  return (
    <div
      className={`h-[466.7px] flex-1 bg-primary-pr500 overflow-hidden flex flex-col items-end justify-start pt-[134.2px] px-[431px] pb-[134px] box-border relative gap-[7.8px] max-w-full text-left text-lgi-4 text-neutral-1000 font-body-base-regular lg:pl-[215px] lg:pr-[215px] lg:box-border mq750:pl-[107px] mq750:pr-[107px] mq750:box-border mq450:pl-5 mq450:pr-5 mq450:box-border ${className}`}
    >
      <img
      ...
      <div className="w-[250.1px] flex flex-row items-start justify-start relative">
        ...
        <div className="h-[54.3px] flex-1 rounded-[46.67px] bg-neutral-n0 flex flex-row items-center justify-start py-[7.8px] px-[11px] box-border gap-[6.8px] whitespace-nowrap">
          <img
