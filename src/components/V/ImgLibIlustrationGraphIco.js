...
const ImgLibIlustrationGraphIco = ({ className = "" }) => {
  return (
    <div
      className={`h-[464.7px] flex-1 bg-[#6099f7] overflow-hidden flex flex-col items-center justify-start pt-[134.2px] px-[431px] pb-[134px] box-border relative gap-[7.8px] max-w-full text-left text-[19.4px] text-[#1c1f25] font-body-base-regular lg:pl-[215px] lg:pr-[215px] lg:box-border mq750:pl-[107px] mq750:pr-[107px] mq750:box-border mq450:pl-5 mq450:pr-5 mq450:box-border ${className}`}
    >
      <img
      ...
      <div className="w-[250.1px] flex flex-row items-center justify-center relative">
        <div className="h-[80.7px] w-[280px] absolute !m-[0] top-[-13.7px] right-[-15px] rounded-[77.78px] bg-[#ffffff33] z-[2]" />
