  ...
  sections: [
    {
      ...
      lIcons: ["/l-icon6@2x.png", "/l-icon7@2x.png", "/l-icon8@2x.png", "/l-icon9@2x.png"],
      texts: ["Company Overview", "Careers", "Press & Media", "Testimonials"],
      rIcons: ["/r-icon8@2x.png", "/r-icon9@2x.png", "/r-icon10@2x.png", "/r-icon11@2x.png"],
    },
    {
      titleText: "Resources",
      propFlex: "0.9521",
      ...
      lIcons: ["/l-icon10@2x.png", "/l-icon11@2x.png", "/l-icon12@2x.png", "/l-icon13@2x.png"],
      texts: ["Blog", "Help Center", "Webinars & Events", "Case Studies"],
      rIcons: ["/r-icon12@2x.png", "/r-icon13@2x.png", "/r-icon14@2x.png", "/r-icon15@2x.png"],
    },
    {
      titleText: "Support & Contact",
      lIcons: ["/l-icon14@2x.png", "/l-icon15@2x.png", "/l-icon16@2x.png", "/l-icon17@2x.png"],
      texts: ["Contact Us", "Technical Support", "Feedback", "Community Forum"],
      rIcons: ["/r-icon16@2x.png", "/r-icon17@2x.png", "/r-icon18@2x.png", "/r-icon19@2x.png"],
    },
    {
      titleText: "Connect",
      propFlex: "0.9863",
      propMinWidth: "66px",
      propDisplay: "inline-block",
      lIcons: ["/l-icon-1.svg", "/l-icon-2@2x.png", "/l-icon-3.svg", "/l-icon-4.svg"],
      texts: ["Instagram", "Facebook", "Twitter / X", "Linkedin"],
      rIcons: ["/r-icon20@2x.png", "/r-icon21@2x.png", "/r-icon22@2x.png", "/r-icon23@2x.png"],
    },
  ],
};
