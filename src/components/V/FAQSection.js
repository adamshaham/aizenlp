...
const FAQSection = ({ className = "" }) => {
  ...
  return (
    <div
      className={`flex-1 bg-[#fff] overflow-hidden flex flex-col items-center justify-start pt-[124.4px] px-5 pb-[108.9px] box-border max-w-full text-left text-[19.4px] text-[#1c1f25] font-dm-sans gap-section-spacing-[11.6px] mq450:pt-[53px] mq450:pb-[46px] mq450:box-border mq1050:pt-[81px] mq1050:pb-[71px] mq1050:box-border ${className}`}
    >
      <div className="w-[1440.6px] flex flex-row flex-wrap items-start justify-start py-0 pl-0 pr-[0px] box-border gap-x-[46.7px] gap-y-[44.7px] max-w-[1440.56px] shrink-0 lg:max-w-full gap-[22px]">
        ...
        />
        <div className="flex-1 flex flex-col items-center justify-start gap-stack-[21px] min-w-[350px] max-w-full">
