...
const V2 = () => {
  return (
    <div className="w-full relative bg-[#fff] overflow-hidden flex flex-col items-start justify-start gap-[14.9px] leading-[normal] tracking-[normal]">
      ...
      <FrameComponent16 />
      <FrameComponent17 />
      <footer className="self-stretch bg-[#051114] flex flex-col items-center justify-start pt-[87.5px] px-5 pb-[30px] box-border gap-[70px] max-w-full shrink-0 text-left text-[11.6px]i-3 text-[#fff] font-poppins mq450:pt-[57px] mq450:pb-5 mq450:box-border gap-[17px] gap-[35px]">
        <img
        ...
        <div className="w-[997.5px] flex flex-row items-start justify-between gap-5 max-w-full mq1125:flex-wrap mq1125:justify-center">
          ...
          <div className="w-[306.6px] flex flex-row items-start justify-start gap-[69.6px] gap-[35px]">
            <div className="w-[101px] flex flex-col items-start justify-start gap-[26.4px]">
              ...
              <div className="flex flex-col items-start justify-start gap-[8.1px] text-[16px] text-[#ffffffb3] font-body-base-regular">
        ...
        <div className="w-[997.5px] flex flex-col items-start justify-start gap-[25.3px] max-w-full text-center text-[16px] text-[#ffffffb3] font-body-base-regular">
